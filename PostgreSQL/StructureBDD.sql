...
COMMENT ON TABLE public.utilisateurs IS "Liste des utilisateurs avec leurs identifiants et leurs droits";
COMMENT ON COLUMN public.utilisateurs.id_utilisateur IS "Identifiant unique d'un utilisateur";
COMMENT ON COLUMN public.utilisateurs.pseudo IS "Pseudo de l'utilisateur, qui s'affiche dans la liste des utilisateurs et qui peut être utilisé pour se connecter.
Pour contacter l'utilisateur, on sélectionnera idéalement son pseudo dans la liste sans jamais voir son email";
COMMENT ON COLUMN public.utilisateurs.mail IS "Email de l'utilisateur";
COMMENT ON COLUMN public.utilisateurs.id_utilisateur IS "Identifiant unique d'un utilisateur";
COMMENT ON COLUMN public.utilisateurs.id_utilisateur IS "Identifiant unique d'un utilisateur";
